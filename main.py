# -*- coding: utf-8 -*-
# Copyright (C) 2021 github.com/schmerzhafttt
#
...
(____/ \__ _)\____)_) (_)\___/|  __/ 
                              | |    
                              (_)    {colours['white']}
> Made with {colours['main_colour']}<3{colours['white']} by {colours['main_colour']}GladionStar{colours['white']}
> Github: {colours['main_colour']}https://github.com/schmerzhafttt{colours['white']}
> Don't forget to {colours['yellow']}star{colours['white']} it!
> Version: {colours['main_colour']}{app_version}""")
        
    try: ctypes.windll.kernel32.SetConsoleTitleW(f"github.com/schmerzhafttt/gladion")
    except: pass
